        ...
        <div style={{ maxWidth: 1040, padding: "6px 6px 40px" }}>
            ...
            >
                ...
                <div style={{ padding: "0 20px 20px 22px", borderTop: "1px solid var(--border-muted)" }}>
                    ...
                    {/* "Tip S" (short-squeeze) bölümü 2026-08-06'da kaldırıldı.
                        Type S sınıflandırması 2026-08-04'te SİLİNDİ: girdisi (short interest,
                        days-to-cover) geçmişe dönük mevcut olmadığı için hiç doğrulanamamıştı ve
                        katalizör modülü silinince dal ulaşılamaz hale geldi. 18 ayar paneli
                        kalmıştı — var olmayan bir stratejiyi ayarlıyormuş izlenimi veriyordu. */}
